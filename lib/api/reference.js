...
module.exports = {
   ...
   * @param {String} params.bankAccountCountry Country of the beneficiary's bank, required
   * @param {String} params.currency           Currency in which money is held in the beneficiary's bank account, required
  ...
  getBeneficiaryRequiredDetails: function (params) {
    params = params || {};
    if(!params.hasOwnProperty('bankAccountCountry')) {
      throw new Error('bankAccountCountry is required');
    }
  ...
  getBankDetails: function (params) {
    ...
    var url = '/v2/reference/bank_details/find';
