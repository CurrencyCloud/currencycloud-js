...
module.exports = function(err) {
  ...
  switch(err.statusCode) {
    case 400: return new BadRequestError(err);
    case 401: return new AuthenticationError(err);
    case 403: return new ForbiddenError(err);
    case 404: return new NotFoundError(err);
    case 429: return new TooManyRequestsError(err);
    case 500: return new InternalApplicationError(err);
    default: return new UndefinedError(err);
  }
};
